...
export class BoardArticleResolver {
    ...
    // createBoardArticleAdd commentMore actions
	@UseGuards(AuthGuard)
	...
	public async createBoardArticle(
		...
		const result = await this.boardArticleService.createBoardArticle(memberId, input);
	...
	//likeTargetBoardArticleAdd commentMore actions
	@UseGuards(AuthGuard)
